...
export class NewsRoutes extends CommonRoutesConfig {
    ...
    configureRoutes(): express.Application {
        ...
        this.app.post(`/v1/news/register`, [
            ...
            body('version').isString().notEmpty().withMessage('Version can\'t be empty'),
            body('messages').isArray().notEmpty().withMessage('Messages can\'t be empty'),
            body('colors').isArray().notEmpty().withMessage('Colors can\'t be empty'),
            body('newLines').isArray().notEmpty().withMessage('Lines can\'t be empty'),
